...
func (sm *servicesManager) GetHeroesNameList() ([]entities.Hero, error) {
	return sm.GetHeroesNameListPerPatch("7.35c")
}

func (sm *servicesManager) GetHeroesNameListPerPatch(patch string) ([]entities.Hero, error) {
...
func (sm *servicesManager) GetAllHeroesWinrates() ([]entities.Winrate, error) {
	return sm.GetHeroesWinrates(make([]entities.Hero, 0))
}

func (sm *servicesManager) GetHeroesWinrates(heroes []entities.Hero) ([]entities.Winrate, error) {
...
func (sm *servicesManager) GetHeroesCounterPicks(firstHeroes []entities.Hero, secondHeroes []entities.Hero) ([]entities.CounterRate, error) {
